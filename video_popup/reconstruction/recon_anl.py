...
if(expr == 'anliang'):
    ...
    seg_file = '../../data/anliang/tracking/broxmalik_Size2/broxmalikResults' \
               '/f1t30/v5_d4/vw10_nn10_k5_thresh10000_max_occ10_op0_cw2.5/init200/mdl2000_pw10_oc10_engine0_it5/results.pkl'

    K = np.array([[1200, 0,  359.5],
                  [0, 1200,  480  ],
                  [0,    0,      1]])
